...
class MongoIO:
    mongo_ins = None # Establish only once during the lifetime of the application

    def __init__(self):
        if MongoIO.mongo_ins is None:
            mongo_db_url = "mongodb+srv://bayosol372:RodBrx8EjbcXTUaR@cluster0.mnuki.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
